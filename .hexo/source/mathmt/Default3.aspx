...
<body>
    <form id="form1" runat="server">
        ...
        <div class="shop-schedule">
            <div class="schedule">
                <div class="wrapper J_movie_wrap">
                    <div class="scroller ">
                        <a class="item slide" href="Default1.aspx">
                ...
                <div><img src="page2/奥数3主图.png" alt="" /></div><br />

                <div><img class="jieshao" src="page2/奥数3详情.png" alt="" /></div>
        ...
        <script async src="http://m1.s1.dpfile.com/mod/events/1.0.5/events.js"></script>
        ...
        <script async src="http://m1.s1.dpfile.com/mod/json/1.0.1/json.js"></script>
